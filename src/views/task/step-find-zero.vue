<template>
    ...
    <div class="shop-mark-container">
        ...
        <div class="mark-box">
            ...
            <div class="title mt-20 c-primary">
                进店方式({{ orderDetail.search_type == 1 ? '复制淘口令打开淘宝' : '打开手淘扫一扫' }}):
            </div>
            ...
            >
                (点击这行复制):{{ orderDetail.keywords }}
            </div>
            <div class="keywords" v-if="orderDetail && orderDetail.search_type == 2">
                <img :src="orderDetail.keywords" style="width:300px" />
            </div>
        ...
        <div class="tip-wrap">
            ...
            <div class="size-13 mt-5">1、不按照商家要求方式进店的，一经发现扣除赏金</div>
