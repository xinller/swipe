    ...
    <div class="step-detail">
        ...
        <van-collapse v-model="activeName" accordion class="novice-teach">
            <van-collapse-item name="2">
                <template #title>
                    <span :class="['step_tag', { gray: orderDetail.step < 2 }]">1</span>
            ...
            <van-collapse-item name="5">
                <template #title>
                    <span :class="['step_tag', { gray: orderDetail.step < 6 }]">2</span>
            ...
            <van-collapse-item name="7">
                <template #title>
                    <span :class="['step_tag', { gray: orderDetail.step < 7 }]">3</span>
            ...
            <van-collapse-item name="8">
                <template #title>
                    <span :class="['step_tag', { gray: orderDetail.step < 8 }]">4</span>
